...
-- Versi TANPA "CREATE DATABASE"/"USE" — pakai file ini kalau database
-- sudah anda buat duluan lewat panel/phpMyAdmin (mis. karena user
-- database tidak punya izin CREATE DATABASE).
--
-- Cara pakai: pilih dulu database yang sudah anda buat di phpMyAdmin
-- (atau tambahkan "USE nama_database_anda;" di baris pertama), baru
-- jalankan sisa isi file ini.
